...
public class DiskLruCache {
	...
	private final int maxCacheItemSize = 100000; // 默认的最大缓存数量
	private long maxCacheByteSize = 1024 * 1024 * 1024; // 1G 缓存上限
	 ...
	 * @return
	 */
	private boolean writeBitmapToFile(Bitmap bitmap, String file) throws Exception {
